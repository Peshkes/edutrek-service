...
VALUES ('Lead'),('In work'),('Consultaion'),('Save for later'),('Student'),('Archive');
...
VALUES ('Credit card'),('Cash'),('Cheque'),('Online transfer');
...
CREATE TABLE payment_information(
	...
	FOREIGN KEY (payment_type_id) REFERENCES payment_types (payment_type_name),
...
CREATE TABLE weekdays(
	weekday_id int serial PRIMARY KEY,
